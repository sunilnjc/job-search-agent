export type WorkspaceIconName = "discover" | "rank" | "prepare" | "review" | "profile" | "arrow";
...
export function WorkspaceIcon({ name }: { name: WorkspaceIconName }) {
  const paths: Record<WorkspaceIconName, React.ReactNode> = {
    ...
    rank: <><path d="M4 19V9M10 19V5M16 19v-7M22 19V8" /></>,
    prepare: <><rect x="3" y="6" width="15" height="14" rx="3" /><path d="M7 3h11a3 3 0 0 1 3 3v10M10.5 10v6m-3-3h6" /></>,
    review: <><path d="M4 5h16v14H4zM4 14h4l2 3h4l2-3h4M8 9h8" /></>,
